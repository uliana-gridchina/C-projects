...
void search_in_file(size_t count, FILE* file) {
    ...
    if ( (num_field == 1) || (num_field == 5) || (num_field == 6) ) { //если выбор 1/5/6, то значение для поиска записываем в строку
